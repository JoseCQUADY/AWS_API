...
export const createProfesor = (req, res) => {
    try {
        const { numeroEmpleado, nombre, apellidos, horasClase } = req.body;
        const profesor = new Profesor(numeroEmpleado, nombre, apellidos, horasClase);
...
export const updateProfesor = (req, res) => {
    try {
        ...
        Object.assign(profesor, { numeroEmpleado, nombre, apellidos, horasClase });
